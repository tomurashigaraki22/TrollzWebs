...
const LastSection = () => {
  ...
  return (
    <div className="pl-[90px] max-md:pl-[20px] flex gap-10 items-center justify-center h-[400px] max-md:flex-col max-md:items-center">
      {/* Left Part */}
      <div className="bg-gray-200 w-[400px] h-[350px] max-md:w-full max-md:h-auto rounded-md shadow-lg flex flex-col gap-4 p-6 max-md:mb-6 max-md:text-center">
